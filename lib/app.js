...
var tmsp = require("tmsp-server");
var types = tmsp.types;
...
App.prototype._run = function _run(req, res, route, chain, cb) {
    ...
    function _responseClose() {
        resClosed = true;
        res.clientClosed = true;
    }
    res.once('close', _responseClose);
...
//            n.ifError = ifError(n);
        ...
        res.removeListener('close', _responseClose);
